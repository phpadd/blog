...
/***********内容*********/
for($i=0;$i<4;$i++){
        $fontcolor=imagecolorallocate($im,mt_rand(0,80),mt_rand(0,80),mt_rand(0,80)); //这样保证随机出来的颜色较深。
        $codex=iconv("GB2312","UTF-8",substr($code,$i*2,2));
        imagettftext($im,14,mt_rand(-60,60),20*$i+10,mt_rand(20,25),$fontcolor,$fontface,$codex);
}
imagepng($im);
imagedestroy($im);
